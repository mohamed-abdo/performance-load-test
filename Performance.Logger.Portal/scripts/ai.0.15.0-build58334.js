...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var _InternalLogging = (function () {
            ...
            _InternalLogging.throwInternalNonUSDrActionable = function (severity, message) {
                if (this.enableDebugExceptions()) {
                    throw message;
                }
                else {
                    this.warnToConsole(message);
                    this.logInternalMessage(severity, this.AiNonUSDrActionablePrefix + message);
                }
            };
            _InternalLogging.throwInternalUSDrActionable = function (severity, message) {
                if (this.enableDebugExceptions()) {
                    throw message;
                }
                else {
                    this.warnToConsole(message);
                    this.logInternalMessage(severity, this.AiUSDrActionablePrefix + message);
                }
            };
            ...
            _InternalLogging.logInternalMessage = function (severity, message) {
                ...
                if (this._messageCount == this.MAX_INTERNAL_MESSAGE_LIMIT) {
                    var throttleLimitMessage = this.AiNonUSDrActionablePrefix + "Internal events throttle limit per PageView reached for this app.";
            ...
            _InternalLogging.AiUSDrActionablePrefix = "AI: ";
            _InternalLogging.AiNonUSDrActionablePrefix = "AI (Internal): ";
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        var Util = (function () {
            ...
            Util.canUSDLocalStorage = function () {
            ...
            Util.getStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "Browser failed read of local storage." + Util.dump(e));
                    }
                }
                return null;
            };
            Util.setStorage = function (name, data) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "Browser failed write to local storage." + Util.dump(e));
                    }
                }
                return false;
            };
            Util.removeStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "Browser failed removal of local storage item." + Util.dump(e));
                    }
                }
                return false;
            };
            ...
            Util.canUSDSessionStorage = function () {
            ...
            Util.getSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Browser failed read of session storage." + Util.dump(e));
                    }
                }
                return null;
            };
            Util.setSessionStorage = function (name, data) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Browser failed write to session storage." + Util.dump(e));
                    }
                }
                return false;
            };
            Util.removeSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Browser failed removal of session storage item." + Util.dump(e));
                    }
                }
                return false;
            };
    ...
    (function (ApplicationInsights) {
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                var output = {};
                if (!source) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, "cannot serialize " + name + " becaUSD it is null or undefined");
                    return output;
                }
                if (source[circularReferenceCheck]) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Circular reference detected while serializing: '" + name);
                    return output;
                }
                if (!source.aiDataContract) {
                    if (name === "measurements") {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Attempting to serialize an object which does not implement ISerializable: " + name);
                        try {
                            JSON.stringify(source);
                            output = source;
                        }
                        catch (e) {
                            ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, e && typeof e.toString === 'function' ? e.toString() : "Error serializing object");
                        }
                    }
                    return output;
                }
                ...
                for (var field in source.aiDataContract) {
                    ...
                    if (isRequired && !isPresent && !isArray) {
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Missing required field specification: The field '" + field + "' on '" + name + "' is required but not present on source");
                        continue;
                    }
                    var value;
                    if (isObject) {
            ...
            Serializer._serializeArray = function (sources, name) {
                ...
                if (!!sources) {
                    if (!ApplicationInsights.Util.isArray(sources)) {
                        ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, "This field was specified as an array in the contract but the item is not an array.\r\n" + name);
                    }
                    else {
                        output = [];
                ...
                if (map) {
                    ...
                    for (var field in map) {
                        ...
                        if (expectedType === "string") {
                            ...
                            ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, output[field]);
                        }
                    }
                }
                return output;
...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.USDrAccountAcquisitionDate = "ai.USDr.accountAcquisitionDate";
            this.USDrAccountId = "ai.USDr.accountId";
            this.USDrAgent = "ai.USDr.USDrAgent";
            this.USDrId = "ai.USDr.id";
            this.USDrStoreRegion = "ai.USDr.storeRegion";
            this.USDrAuthUSDrId = "ai.USDr.authUSDrId";
            this.USDrAnonymousUSDrAcquisitionDate = "ai.USDr.anonUSDrAcquisitionDate";
            this.USDrAuthenticatedUSDrAcquisitionDate = "ai.USDr.authUSDrAcquisitionDate";
    ...
    (function (ApplicationInsights) {
        var SamplingScoreGenerator = (function () {
            ...
            SamplingScoreGenerator.getScore = function (envelope) {
                ...
                var score = 0;
                if (envelope.tags[tagKeys.USDrId]) {
                    score = SamplingScoreGenerator.getSamplingHashCode(envelope.tags[tagKeys.USDrId]) / SamplingScoreGenerator.INT_MAX_VALUE;
                }
            ...
            var Sample = (function () {
                function Sample(sampleRate) {
                    ...
                    if (sampleRate > 100 || sampleRate < 0) {
                        ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Sampling rate is out of range (0..100): '" + sampleRate + "'. Sampling will be disabled, you may be sending too much data which may affect your AI service level.");
                        this.sampleRate = 100;
                    }
            ...
            var _SessionManager = (function () {
                ...
                _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
                    ...
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Error parsing ai_session cookie, session will be reset: " + ApplicationInsights.Util.dump(e));
                    }
                    if (this.automaticSession.renewalDate == 0) {
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "AI session renewal date is 0, session will be reset.");
                    }
                };
                _SessionManager.prototype.renew = function () {
                    ...
                    if (!ApplicationInsights.Util.canUSDLocalStorage()) {
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "Browser does not support local storage. Session durations will be inaccurate.");
                    }
                };
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            "USD strict";
            var USDr = (function () {
                function USDr(accountId) {
                    var cookie = ApplicationInsights.Util.getCookie(USDr.USDrCookieName);
                    if (cookie) {
                        var params = cookie.split(USDr.cookieSeparator);
                        if (params.length > 0) {
                            this.id = params[0];
                        }
                    }
                    if (!this.id) {
                        ...
                        ApplicationInsights.Util.setCookie(USDr.USDrCookieName, newCookie.join(USDr.cookieSeparator) + ';expires=' + date.toUTCString());
                        ApplicationInsights.Util.removeStorage('ai_session');
                    }
                    this.accountId = accountId;
                    var authCookie = ApplicationInsights.Util.getCookie(USDr.authUSDrCookieName);
                    if (authCookie) {
                        authCookie = decodeURI(authCookie);
                        var authCookieString = authCookie.split(USDr.cookieSeparator);
                ...
                USDr.prototype.setAuthenticatedUSDrContext = function (authenticatedUSDrId, accountId) {
                    var isInvalidInput = !this.validateUSDrInput(authenticatedUSDrId) || (accountId && !this.validateUSDrInput(accountId));
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Setting auth USDr context failed. " + "USDr auth/account id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
                    this.authenticatedId = authenticatedUSDrId;
                    var authCookie = this.authenticatedId;
                    if (accountId) {
                        this.accountId = accountId;
                        authCookie = [this.authenticatedId, this.accountId].join(USDr.cookieSeparator);
                    }
                    ApplicationInsights.Util.setCookie(USDr.authUSDrCookieName, encodeURI(authCookie));
                };
                USDr.prototype.clearAuthenticatedUSDrContext = function () {
                    this.authenticatedId = null;
                    this.accountId = null;
                    ApplicationInsights.Util.deleteCookie(USDr.authUSDrCookieName);
                };
                USDr.prototype.validateUSDrInput = function (id) {
                    if (typeof id !== 'string' || !id || id.match(/,|;|=| |\|/)) {
                        return false;
                    }
                    return true;
                };
                USDr.cookieSeparator = '|';
                USDr.USDrCookieName = 'ai_USDr';
                USDr.authUSDrCookieName = 'ai_authUSDr';
                return USDr;
            })();
            Context.USDr = USDr;
        })(Context = ApplicationInsights.Context || (ApplicationInsights.Context = {}));
        ...
        var Sender = (function () {
            ...
            Sender.prototype.send = function (envelope) {
                ...
                try {
                    ...
                    if (!envelope) {
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Cannot send empty telemetry");
                        return;
                    }
                    if (!this._sender) {
                        ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Sender was not initialized");
                        return;
                    }
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Failed adding telemetry to the sender's buffer, some telemetry will be lost: " + ApplicationInsights.Util.dump(e));
                }
            };
            ...
            Sender.prototype.triggerSend = function (async) {
                ...
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "Telemetry transmission failed, some telemetry will be lost: " + ApplicationInsights.Util.dump(e));
                }
            };
            ...
            Sender._onError = function (payload, message, event) {
                ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "Failed to send telemetry:\n" + message);
            };
                    ...
                    DataSanitizer.sanitizeKey = function (name) {
                        if (name) {
                            ...
                            if (name.search(/[^0-9a-zA-Z-._()\/ ]/g) >= 0) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "name contains illegal characters. Illgeal character have been replaced with '_'. new name: " + name);
                            }
                            if (name.length > DataSanitizer.MAX_NAME_LENGTH) {
                                name = name.substring(0, DataSanitizer.MAX_NAME_LENGTH);
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "name is too long.  It has been truncated to " + DataSanitizer.MAX_NAME_LENGTH + " characters.  name: " + name);
                            }
                        }
                        return name;
                    };
                    DataSanitizer.sanitizeString = function (value) {
                        if (value) {
                            ...
                            if (value.toString().length > DataSanitizer.MAX_STRING_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "string value is too long. It has been truncated to " + DataSanitizer.MAX_STRING_LENGTH + " characters. value: " + value);
                            }
                        }
                        return value;
                    };
                    DataSanitizer.sanitizeUrl = function (url) {
                        if (url) {
                            if (url.length > DataSanitizer.MAX_URL_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "url is too long, it has been trucated to " + DataSanitizer.MAX_URL_LENGTH + " characters. url: " + url);
                            }
                        }
                        return url;
                    };
                    DataSanitizer.sanitizeMessage = function (message) {
                        if (message) {
                            if (message.length > DataSanitizer.MAX_MESSAGE_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "message is too long, it has been trucated to " + DataSanitizer.MAX_MESSAGE_LENGTH + " characters.  message: " + message);
                            }
                        }
                        return message;
                    };
                    DataSanitizer.sanitizeException = function (exception) {
                        if (exception) {
                            if (exception.length > DataSanitizer.MAX_EXCEPTION_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "exception is too long, iit has been trucated to " + DataSanitizer.MAX_EXCEPTION_LENGTH + " characters.  exception: " + exception);
                            }
                        }
                        return exception;
                    };
            ...
            var PageViewPerformance = (function (_super) {
                ...
                function PageViewPerformance(name, url, durationMs, properties, measurements) {
                    ...
                    if (timing) {
                        ...
                        if (total == 0) {
                            ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "error calculating page view performance: total='" + total + "', network='" + network + "', request='" + request + "', response='" + response + "', dom='" + dom + "'");
                        }
                        else if (total < Math.floor(network) + Math.floor(request) + Math.floor(response) + Math.floor(dom)) {
                            ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "client performance math error:" + total + " < " + network + " + " + request + " + " + response + " + " + dom);
                        }
                        else {
                            durationMs = total;
        ...
        var TelemetryContext = (function () {
            function TelemetryContext(config) {
                ...
                if (typeof window !== 'undefined') {
                    ...
                    this.USDr = new ApplicationInsights.Context.USDr(config.accountId());
            ...
            TelemetryContext.prototype.track = function (envelope) {
                if (!envelope) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, "cannot call .track() with a null or undefined argument");
                }
                else {
            ...
            TelemetryContext.prototype._track = function (envelope) {
                ...
                this._applyUSDrContext(envelope, this.USDr);
                ...
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(0 /* CRITICAL */, "One of telemetry initializers failed, telemetry item will not be sent: " + ApplicationInsights.Util.dump(e));
                }
            ...
            TelemetryContext.prototype._applyUSDrContext = function (envelope, USDrContext) {
                if (USDrContext) {
                    var tagKeys = new AI.ContextTagKeys();
                    if (typeof USDrContext.accountAcquisitionDate === "string") {
                        envelope.tags[tagKeys.USDrAccountAcquisitionDate] = USDrContext.accountAcquisitionDate;
                    }
                    if (typeof USDrContext.accountId === "string") {
                        envelope.tags[tagKeys.USDrAccountId] = USDrContext.accountId;
                    }
                    if (typeof USDrContext.agent === "string") {
                        envelope.tags[tagKeys.USDrAgent] = USDrContext.agent;
                    }
                    if (typeof USDrContext.id === "string") {
                        envelope.tags[tagKeys.USDrId] = USDrContext.id;
                    }
                    if (typeof USDrContext.authenticatedId === "string") {
                        envelope.tags[tagKeys.USDrAuthUSDrId] = USDrContext.authenticatedId;
                    }
                    if (typeof USDrContext.storeRegion === "string") {
                        envelope.tags[tagKeys.USDrStoreRegion] = USDrContext.storeRegion;
                    }
                }
            };
        ...
        (function (Telemetry) {
            ...
            var PageVisitTimeManager = (function () {
                ...
                PageVisitTimeManager.prototype.startPageVisitTimer = function (pageName, pageUrl) {
                    try {
                        if (ApplicationInsights.Util.canUSDSessionStorage()) {
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    appUSDrId: function () { return _this.config.appUSDrId; },
            ...
            AppInsights.prototype.startTrackPage = function (name) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "startTrackPage failed, page view may not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.stopTrackPage = function (name, url, properties, measurements) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "stopTrackPage failed, page view will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.trackPageView = function (name, url, properties, measurements) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "trackPageView failed, page view will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
                ...
                if (ApplicationInsights.Telemetry.PageViewPerformance.isPerformanceTimingSupported()) {
                    ...
                    var handle = setInterval(function () {
                        try {
                            ...
                            ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "trackPageView failed on page load calculation: " + ApplicationInsights.Util.dump(e));
                        }
                    }, 100);
                }
            };
            AppInsights.prototype.startTrackEvent = function (name) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "startTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.stopTrackEvent = function (name, properties, measurements) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "stopTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.trackEvent = function (name, properties, measurements) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "trackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.trackException = function (exception, handledAt, properties, measurements) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "trackException failed, exception will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.trackMetric = function (name, average, sampleCount, min, max, properties) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "trackMetric failed, metric will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.trackTrace = function (message, properties) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, "trackTrace failed, trace will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            ...
            AppInsights.prototype.flush = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "flush failed, telemetry will not be collected: " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.setAuthenticatedUSDrContext = function (authenticatedUSDrId, accountId) {
                try {
                    this.context.USDr.setAuthenticatedUSDrContext(authenticatedUSDrId, accountId);
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Setting auth USDr context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUSDrContext = function () {
                try {
                    this.context.USDr.clearAuthenticatedUSDrContext();
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "Clearing auth USDr context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.SendCORSException = function (properties) {
                var exceptionData = Microsoft.ApplicationInsights.Telemetry.Exception.CreateSimpleException("Script error.", "Error", "unknown", "unknown", "The browser’s same-origin policy prevents us from getting the details of this exception.The exception occurred in a script loaded from an origin different than the web page.For cross- domain error reporting you can USD crossorigin attribute together with appropriate CORS HTTP headers.For more information please see http://www.w3.org/TR/cors/.", 0, null);
            ...
            AppInsights.prototype._onerror = function (message, url, lineNumber, columnNumber, error) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, "_onerror threw " + exceptionDump + " while logging error, error will not be collected: " + errorString);
                }
            };
            return AppInsights;
        })();
        ...
        var Timing = (function () {
            ...
            Timing.prototype.start = function (name) {
                if (typeof this._events[name] !== "undefined") {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "start" + this._name + " was called more than once for this event without calling stop" + this._name + ". key is '" + name + "'");
                }
            ...
            Timing.prototype.stop = function (name, url, properties, measurements) {
                ...
                if (isNaN(start)) {
                    ApplicationInsights._InternalLogging.throwInternalUSDrActionable(1 /* WARNING */, "stop" + this._name + " was called without a corresponding start" + this._name + " . Event name is '" + name + "'");
                }
                else {
                    var end = +new Date;
        ...
        var Initialization = (function () {
            ...
            Initialization.prototype.emptyQueue = function () {
                try {
                    ...
                    Microsoft.ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(1 /* WARNING */, message);
                }
            };
            ...
            Initialization.prototype.addHoUSDkeepingBeforeUnload = function (appInsightsInstance) {
                if ('onbeforeunload' in window) {
                    var performHoUSDkeeping = function () {
                        appInsightsInstance.context._sender.triggerSend();
                        appInsightsInstance.context._sessionManager.backup();
                    };
                    if (!Microsoft.ApplicationInsights.Util.addEventHandler('beforeunload', performHoUSDkeeping)) {
                        Microsoft.ApplicationInsights._InternalLogging.throwInternalNonUSDrActionable(0 /* CRITICAL */, 'Could not add handler for beforeunload');
                    }
                }
            };
            Initialization.getDefaultConfig = function (config) {
                ...
                config.appUSDrId = config.appUSDrId;
    ...
    try {
        if (typeof window !== "undefined" && typeof JSON !== "undefined") {
            ...
            if (window[aiName] === undefined) {
                ...
                init.addHoUSDkeepingBeforeUnload(appInsightsLocal);
            }
        }
    }
    catch (e) {
