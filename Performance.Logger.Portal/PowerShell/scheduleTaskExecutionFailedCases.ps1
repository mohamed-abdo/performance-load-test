...
$cmd="$location\runner.ps1 -unitTestScript ""$baselocartoin\UnitTest\Collections\PerformanceTest_Fail.postman_collection.json""-unitTestEnvironment ""$baselocartoin\UnitTest\Environments\GeexGate-Test.postman_environment.json"" -parallelProcess 10 -iterations 1 -unitTestScriptLocation ""$location""";
